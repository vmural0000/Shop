...
namespace QuickApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ViewUsersPolicy)).Succeeded)
        ...
        public async Task<IActionResult> GetUserByUserName(string userName)
        {
            ...
            if (!(await _authorizationService.AuthorizeAsync(this.User, appUser?.Id ?? "", AuthPolicies.ViewUsersPolicy)).Succeeded)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            var manageUsersPolicy = _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ManageUsersPolicy);
            var assignRolePolicy = _authorizationService.AuthorizeAsync(this.User, Tuple.Create(user.Roles, currentRoles), AuthPolicies.ManageUsersPolicy);
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ManageUsersPolicy)).Succeeded)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> GetRoleById(string id)
        {
            ...
            if (!(await _authorizationService.AuthorizeAsync(this.User, appRole?.Name ?? "", AuthPolicies.ViewRolesPolicy)).Succeeded)
                return new ChallengeResult();
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, name, AuthPolicies.ViewRolesPolicy)).Succeeded)
                return new ChallengeResult();
