...
export class RoleEditorComponent {
    ...
    private saveSuccessHelper(role?: Role) {
        ...
        if (this.isNewRole)
            this.alertService.success(`Role \"${this.roleEdit.name}\" was created successfully`);
        else
            this.alertService.success(`Changes to role \"${this.roleEdit.name}\" was saved successfully`);
