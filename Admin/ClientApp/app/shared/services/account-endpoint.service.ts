...
export class AccountEndpoint extends EndpointFactory {
    ...
    constructor(http: Http, configurations: ConfigurationService, injector: Injector, @Inject('BASE_URL') public baseUrl: string) {

        super(http, configurations, injector, baseUrl);
    }
