...
export class TranslationService {
    ...
    useBrowserLanguage(): string | void {
        ...
        if (browserLang.match(/en|ru|uk/)) {
            this.changeLanguage(browserLang);
            return browserLang;
        }
    }

    changeLanguage(language: string = "uk") {
    ...
    getAsync(key: string | Array<string>, interpolateParams?: Object): Observable<string | any> {
...
export class TranslateLanguageLoader implements TranslateLoader {
    ...
    public getTranslation(lang: string): any {
        ...
        switch (lang) {
            ...
            case "ru":
                return Observable.of(require("../../assets/locale/uk.json"));
            case "uk":
                return Observable.of(require("../../assets/locale/uk.json"));
            default:
        }
