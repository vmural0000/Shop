...
//public void Upload(IFormCollection collection)// id product
//{
//if (file == null) throw new Exception("File is null");
//if (file.Length == 0) throw new Exception("File is empty");

//var uploads = Path.Combine(_env.WebRootPath, "ProductImages");
//var DbFile = new Image(file.FileName);

//add to db file
//using (var fileStream = new FileStream(Path.Combine(uploads, DbFile.FileName), FileMode.Create))
//{
...
//{
//var uploads = Path.Combine(_env.WebRootPath, "ProductImages");
//File.Delete(Path.Combine(uploads, id));
//}
